...
function compareWords() {
    ...
    function pickMessage(){
        ...
        if (wordCount===2){
            messageArray=['נולדת לוורדל׳ה','גאוני','אמאל׳ה הצלחת מהר','אחלה תוצאה שבעולם','נראה שהלך מדהים','!!!טירוף','שני ניחושים? קטונתי','יש לך מוח ענק','תוצאה מפחידה','וואו פשוט וואו','בגלגול הקודם היית מילונאי','אין לנו מה לומר, הצלחת','מזל של מתחילים','הלכת אול אין וניצחת','לא רואים אבל אני משתחווה']
        }
        if (wordCount===3){
        ...
        if (wordCount===4){
            messageArray=['הצלחתך הצלחתינו.צבי','לא רע בכלל','סחתיין עליך','יופי יופי יופי','כפיים לך, הצלחת','נראה לי שיש פה ניחוש מעולה','נתת בראש','אחלה תוצאה שבעולם','עם התמדה מגיעים להכל','פתרת כמו גדול/ה','אחלה בחלה','יופי טופי','משחק טוב כל הכוד','שיחקת מעולה','נהדר ומצוין ואחלה ויופי','כבוד הולך אליך על הפתירה','אז לא עברת טסט ראשון, לא נורא','ארבע זה מספר טיפולוגי','כנגד ארבעה ניחושים דיברה המילה']
        }
        if (wordCount===5){
